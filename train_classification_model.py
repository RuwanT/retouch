from custom_networks import retouch_dual_net, retouch_vgg_net, retouch_unet, retouch_vgg_net_classify
...
def train_model():
    ...
    model = retouch_vgg_net_classify(input_shape=(PATCH_SIZE, PATCH_SIZE, 3))
